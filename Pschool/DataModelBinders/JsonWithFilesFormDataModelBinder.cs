...
namespace Pschool.Shared.DataModelBinders
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            {
                if (property.ModelType != typeof(IFormFileCollection) && property.ModelType != typeof(IFormFile))
                    continue;

                var fieldName = string.IsNullOrEmpty(property.BinderModelName) ? property.PropertyName : property.BinderModelName;
